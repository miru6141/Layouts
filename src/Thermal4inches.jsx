...
const Thermal4inches = () => {
  return (
    <div className="w-[4in] p-2 text-[10px] font-mono m-2"> {/* Updated width to 4 inches */}
      ...
      <div className='border-dashed border-t border-b border-black'>
        ...
        <tbody className='text-xs'>
          {
            invoiceData.items.map((data) => (
              <>
                <tr key={data.S_N} className='flex flex-row justify-between p-1 text-xs border-dashed border-black border-t'>
                  <td>{data.S_N}</td>
                  <td>{data.quantity}</td>
                  <td></td>
                ...
                <tr className='grid grid-cols-3'>
                  ...
                  <td className='text-center col-span-1'>{`HSN:${data.hsn}`}</td>
                </tr>
              </>
            ))
          }
      ...
      <div className="text-center text-xs mt-2">
        <div className='border-dashed border-b border-black'> 
          <ol className='text-start font-bold pl-1'> Terms & Conditions
